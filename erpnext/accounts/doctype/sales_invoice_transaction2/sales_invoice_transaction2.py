...
from erpnext.controllers.selling_controller_transaction import SellingControllerTransaction
...
class SalesInvoiceTransaction2(SellingControllerTransaction):
	tname = 'Merchandise Items'
	fname = 'merchandise_items'

	def __init__(self, arg1, arg2=None):
		super(SalesInvoiceTransaction2, self).__init__(arg1, arg2)
		self.status_updater = [{
			'source_dt': 'Merchandise Items',
	...
	def validate(self):
		super(SalesInvoiceTransaction2, self).validate()
	...
	def set_missing_values(self, for_validate=False):
		...
		super(SalesInvoiceTransaction2, self).set_missing_values(for_validate)
	...
	def get_advances(self):
		super(SalesInvoiceTransaction2, self).get_advances(self.debit_to,
	...
	def validate_with_previous_doc(self):
		super(SalesInvoiceTransaction2, self).validate_with_previous_doc(self.tname, {
			"Sales Order": {
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(frappe.defaults.get_global_default("auto_accounting_for_stock")) \
			...
			gl_entries += super(SalesInvoiceTransaction2, self).get_gl_entries()
