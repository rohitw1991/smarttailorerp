...
cur_frm.cscript.tname = "Merchandise Items";
cur_frm.cscript.fname = "merchandise_items";
...
erpnext.accounts.SalesInvoiceTransactionController = erpnext.selling.SellingController.extend({
	onload: function() {
		this._super();
...
$.extend(cur_frm.cscript, new erpnext.accounts.SalesInvoiceTransactionController({frm: cur_frm}));
