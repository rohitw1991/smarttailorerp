...
class SalesOrderTransaction(SellingController):
	...
	def validate_order_type(self):
		super(SalesOrderTransaction, self).validate_order_type()
	...
	def validate(self):
		...
		super(SalesOrderTransaction, self).validate()
	...
	def validate_with_previous_doc(self):
		super(SalesOrderTransaction, self).validate_with_previous_doc(self.tname, {
			"Quotation": {
	...
	def check_modified_date(self):
		mod_db = frappe.db.get_value("Sales Order Transaction", self.name, "modified")
...
def make_material_request(source_name, target_doc=None):
	...
	doc = get_mapped_doc("Sales Order Transaction", source_name, {
...
def make_delivery_note(source_name, target_doc=None):
	...
	target_doc = get_mapped_doc("Sales Order Transaction", source_name, {
		"Sales Order Transaction": {
